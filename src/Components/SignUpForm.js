...
const SignUpForm = () => {
    ...
    return (
        <div>
            <div className="form">
                <h1 style={{fontWeight: 300 , fontSize: '30px'}}>Signup</h1>
                ...
                {
                   (errorMessage)&&(
                    <p style={{color:'red'}} id="errorMessage">Error : {errorMessage}</p>
                   ) 
                }
                 {
                   (successMessage)&&(
                    <p style={{color:"green"}} id="success-message">{successMessage}</p>
                   ) 
                }
                <button id="signup-form" className="btns signup-btn" 
                    onClick={submitForm}
                >
                    Signup
                </button>
